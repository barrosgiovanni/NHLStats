...
internal class Program
{
    ...
    static void BuildDBFromFile()
    {
        ...
        {
            Console.WriteLine($"Error with building data base from file: {ex.Message}");
        }
    }
    ...
    public static void PrintValuesSorted(List<Stats> players, string sort) // Patricia
    {
         ...
         {
                Console.WriteLine($"Error with printing the sorted values: {ex.Message}");
         }
    ...
    public static void FilterByName() // Patricia
    {
            try
            {
              ...
              Console.WriteLine($"Error with filtering by name: {ex.Message}");
       }
